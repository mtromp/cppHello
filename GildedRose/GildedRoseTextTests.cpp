...
int main()
{
    ...
    items.push_back(new Item("Sulfuras, Hand of Ragnaros", -1, 80));
    items.push_back(new Item("Backstage passes to a TAFKAL80ETC concert", 15, 20));
    items.push_back(new Item("Backstage passes to a TAFKAL80ETC concert", 10, 49));
    items.push_back(new Item("Backstage passes to a TAFKAL80ETC concert", 5, 49));
